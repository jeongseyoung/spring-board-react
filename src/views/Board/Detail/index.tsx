...
export default function BoardDetail() {
  ...
  const BoardDetainTop = () => {
    return (
      <>
        <div id="board-detail-top">
          <div className="board-detail-top-header">
            <div className="board-detail-title">{"it's monday"}</div>
            <div className="board-detail-top-sub-box">
              <div className="board-detail-write-info-box">
                <div className="board-detail-write-profile-image"></div>
                <div className="board-detail-write-nickname">{"ss"}</div>
                <div className="board-detail-info-divider">{"|"}</div>
                <div className="board-detail-write-date">{"2000-00-00"}</div>
              </div>
          ...
          <div className="board-detail-top-main">
            <div className="board-detail-main-text">{"오늘은 월요일~"}</div>
      ...
      <>
        <div id="board-detail-bottom">
          ...
          <div className="board-detail-bottom-comment-box">
            <div className="boarde-detail-bottom-comment-container">
